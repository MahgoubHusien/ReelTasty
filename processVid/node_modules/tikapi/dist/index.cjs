...
var exampleVideoIdMoreParameters = "7003402629929913605";
  ...
  const on_success = function(res, req) {
    const nextItems = function() {
      ...
      if (res.json.hasMore || res.json.has_more) {
        let currentCursorField = ((_a = res.json) == null ? void 0 : _a.cursor) || ((_b = res.json) == null ? void 0 : _b.offset) || ((_c = res.json) == null ? void 0 : _c.nextCursor);
        nextCursorParams = __spreadProps(__spreadValues({}, nextCursorParams), {
    ...
    const saveVideo = function(link, path, fetchOptions) {
      return __async(this, null, function* () {
        ...
        return fetch(link, __spreadValues({
          "method": "GET",
          "headers": headers
        }, fetchOptions)).then((res2) => {
          if (!res2.ok) {
